 ...
 *
 * This file is automatically generated by chowbea CLI.
 ...
 *
 * This file is generated once by chowbea CLI.
	...
	if (!instanceExists || force) {
		...
		if (drift) {
			logger.warn(
				...
				`api.instance.ts is out of sync with [instance] config (changed: ${drift.changedFields.join(", ")}). Run 'chowbea init --force' or delete ${outputPaths.instance} to regenerate.`,
			);
		} else {
